...
const GoogleLogo: React.FC<GoogleLogoProps> = ({ theme, isMobile, size = 'medium' }) => {
  let width, height;
  ...
  switch(size) {
    case 'small':
      ...
      break;
    case 'large':
      width = isMobile ? "160" : "272";
      height = isMobile ? "53" : "92";
      break;
    case 'medium':
    default:
  ...
  return (
    <svg viewBox="0 0 272 92" width={width} height={height}>
      <path
